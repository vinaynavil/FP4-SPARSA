...
| 4 | Wallace tree partial-product reduction |
...
- 2-stage pipelined adder tree compensates for variable lane counts entering the Wallace tree, avoiding a WNS hit from combinational skip logic
